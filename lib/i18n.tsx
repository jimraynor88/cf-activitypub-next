...
const EN = {
  ...
  e2ee_publish_button: "Generate & publish key package",
  e2ee_publish_desc: "Generates a fresh RFC 9420 key package and publishes it to your keyPackages collection, so others can encrypt to you.",
  ...
  e2ee_send_desc: "Choose a recipient and a plaintext; a ciphertext envelope is built and delivered over ActivityPub.",
  ...
  e2ee_demo_note: "Demo envelope: real MLS cryptography happens in your client. The server never sees plaintext.",
...
const ES: typeof EN = {
  ...
  e2ee_publish_button: "Generar y publicar key package",
  e2ee_publish_desc: "Genera un key package RFC 9420 nuevo y lo publica en tu colección keyPackages, para que otros puedan cifrarte.",
  ...
  e2ee_send_desc: "Elige un destinatario y un texto; se construye un envoltorio de cifrado y se entrega vía ActivityPub.",
  ...
  e2ee_demo_note: "Envoltura de demostración: la criptografía MLS real ocurre en tu cliente. El servidor nunca ve el texto plano.",
