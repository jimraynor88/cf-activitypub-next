...
const EN = {
  ...
  e2ee_send_desc: "Choose a recipient and a plaintext; a demo ciphertext envelope is built and delivered over ActivityPub. Real MLS encryption happens in your client.",
  ...
  e2ee_send_cta: "Send demo message",
...
const ES: typeof EN = {
  ...
  e2ee_send_desc: "Elige un destinatario y un texto; se construye un envoltorio de cifrado de demostración y se entrega vía ActivityPub. El cifrado MLS real ocurre en tu cliente.",
  ...
  e2ee_send_cta: "Enviar mensaje demo",
