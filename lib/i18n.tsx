...
const EN = {
  ...
  e2ee_no_key_packages_sub: "Publish one through your outbox (Create(KeyPackage)) so other users can encrypt messages to you.",
...
const ES: typeof EN = {
  ...
  e2ee_no_key_packages_sub: "Publícalo vía tu outbox (Create(KeyPackage)) para que otros usuarios puedan cifrarte mensajes.",
